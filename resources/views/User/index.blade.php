...
<html lang="en">
  ...
  <body>
    <header>
      ...
      <div class="logo">
        <a href="{{ route('index') }}">GREEN GARDEN</a>
      </div>
      <nav class="navbar">
        <a href="{{ route('index') }}">Home</a>
        <a href="{{ route('login') }}">Endangered Animals</a>
        <a href="{{ route('login') }}">Posts</a>
        <a href="{{ route('login') }}">Education & Awareness</a>
      ...
      <div class="login" id="loginLinks">
        <ul>
          <li>
            <a href="#" onclick="toggleLoginMenu()"
    ...
    <section class="home" id="home">
      <div class="content">
        ...
        <a href="{{ route('login') }}" class="btn">Visit us to know more</a>
      </div>
    </section>
    ...
    <section class="about" id="about">
      ...
      <div class="row">
        ...
        <div class="content">
          ...
          <a href="{{ route('login') }}" class="btn">Learn More About Our Mission</a>
        </div>
      </div>
    </section>
    ...
    @foreach ($post as $post)
        <div class="blog-card">
            ...
            <a href="{{route('login')}}" class="blog-view-more">View More</a>
        </div>
    @endforeach
